<?php 
    class Producto extends Conectar{
        ...
        public function insert_producto($prod_nom,$prod_desc){ //nesecita una variable prod_id
            $conectar = parent::conexion();
            parent::set_names();
        ...
        public function update_producto($prod_id,$prod_nom,$prod_desc){ //nesecita una variable prod_id
            $conectar = parent::conexion();
            parent::set_names();
            ...
            $sql->bindValue(2,$prod_desc); 
            $sql->bindValue(3,$prod_id);  //se necesita un parametro el campo del orden 1,prod_id
            $sql->execute();
            return $resultado=$sql->fetchAll();
        }
    }
